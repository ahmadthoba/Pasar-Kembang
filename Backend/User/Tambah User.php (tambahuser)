              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Silahkan isi form sesuai User Anda</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="/user/tambah" method="post">
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="email" name="email" class="form-control" id="exampleInputPassword1" placeholder="Masukkan Email">
                        </div>
                        <div class="form-group">
